...
<head>
    ...
    <title>Aplikasi Nilai by Nasution</title>
    <link rel="shortcut icon" href="images/logoTKJ.png" type="image/x-icon">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
</head>
<body background="images/DanauAI.jpg">
    ...
    <div class="card">
        <div class="card-body bg-secondary">
            ...
            <span class="float-end">
                Versi 1.0 by <a href="http://imamhakimnasution.rf.gd/" target="_blank" rel="noopener noreferrer">M.Imam Hakim Nasution</a>
            </span>
        </div>
    </div>
</div>
